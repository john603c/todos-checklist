...
Um projeto prático desenvolvido em ReactJS 19 como objetivo de organizar tarefas em uma lista.
...
* **Estilização com CSS Modules**: Organização dos estilos por componente (Futuramente utilizará o Tailwind)
...
Abra a url disponibilizada pelo Vite e explore a aplicação inicialmente clicando no botão "+" para adicionar uma tarefa na lista. Espero que goste :)
